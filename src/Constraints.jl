...
function constraint_def_abs_flow_values(pm::AbstractPowerModel, l::Int; nw::Int=pm.cnw)
    ...
    if haskey( var(pm,nw), :p )
      ...
      upf0m = var(pm,nw, :pd_br)[f_idx,0]
      upf0p = var(pm,nw, :pd_br)[f_idx,1]
      upt0m = var(pm,nw, :pd_br)[t_idx,0]
      upt0p = var(pm,nw, :pd_br)[t_idx,1]

      upf1m = var(pm,nw, :pt_br)[f_idx,0]
      upf1p = var(pm,nw, :pt_br)[f_idx,1]
      upt1m = var(pm,nw, :pt_br)[t_idx,0]
      upt1p = var(pm,nw, :pt_br)[t_idx,1]
    ...
    if haskey( var(pm,nw), :q )
      ...
      uqf0m = var(pm,nw, :qt_br)[f_idx,0]
      uqf0p = var(pm,nw, :qt_br)[f_idx,1]
      uqt0m = var(pm,nw, :qt_br)[t_idx,0]
      uqt0p = var(pm,nw, :qt_br)[t_idx,1]

      uqf1m = var(pm,nw, :qd_br)[f_idx,0]
      uqf1p = var(pm,nw, :qd_br)[f_idx,1]
      uqt1m = var(pm,nw, :qd_br)[t_idx,0]
      uqt1p = var(pm,nw, :qd_br)[t_idx,1]
...
function constraint_abs_branch_flow_ordering(pm::AbstractPowerModel, l::Int; nw::Int=pm.cnw)
    ...
    upf0m = var(pm,nw, :pt_br)[f_idx,0]
    upt0m = var(pm,nw, :pt_br)[t_idx,0]
    upf0p = var(pm,nw, :pt_br)[f_idx,1]
    upt0p = var(pm,nw, :pt_br)[t_idx,1]
    upf1m = var(pm,nw, :pd_br)[f_idx,0]
    upt1m = var(pm,nw, :pd_br)[t_idx,0]
    upf1p = var(pm,nw, :pd_br)[f_idx,1]
    upt1p = var(pm,nw, :pd_br)[t_idx,1]
